    ...
    <div class="rounded-lg border bg-card p-4 md:p-6">
      ...
      <div class="space-y-2">
        ...
        <div class="flex gap-2 justify-end">
          <button
            (click)="cancel()"
            class="rounded-md px-3 py-1 text-xs font-medium text-foreground hover:bg-muted"
          >
            Annuler
          </button>
          <button
            ...
            class="rounded-md bg-primary px-3 py-1 text-xs font-medium text-primary-foreground hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Mettre à jour
          </button>
        </div>
